...
<div class="wrap">
    ...
    <div class="main">
        <div class="content">
            ...
            <div class="con-title">
                <i class="left-line"></i>
                <span>课程分类</span><small>每天，为上万用户找到满意课程</small>
                <div class="see">
                    <p><a href="#">更多分类</a></p>
                </div>
            </div>
            <div class="class-area">
                <div class="class-area-left">
                    <div class="class-group">
                        <div class="class-group-con">
                            <div class="class-group-title"><i class="class-icon-1"></i>孩子教育</div>
                            <ul class="class-group-sub">
                                <li><a href="/list/zaojiao/" data-bh="zaojiao" target="_blank" class="">早教/学前</a></li>
                                <li><a href="/list/shaoeryingyu/" data-bh="shaoeryingyu" target="_blank" class="">少儿英语</a></li>
                                <li><a href="/list/xiaochugao/" data-bh="xiaochugao" target="_blank" class="on">中小学</a></li>
                                <li><a href="#" data-bh="" target="_blank" class="">艺术特长</a></li>
                                <li><a href="/list/ykpx/" data-bh="ykpx" target="_blank" class="">艺考军考</a></li>
                            </ul>
                    ...
                    <div class="class-group">
                        <div class="class-group-con">
                            <div class="class-group-title"><i class="class-icon-3"></i>兴趣/爱好</div>
                            <ul class="class-group-sub">
                                <li><a href="/list/wudaoxingti/" data-bh="wudaoxingti" target="_blank" class="on">舞蹈培训</a></li>
                                <li><a href="/list/yuga/" data-bh="yuga" target="_blank" class="">瑜伽培训</a></li>
                                <li><a href="#" data-bh="" target="_blank" class="">其他兴趣</a></li>
                            </ul>
                    ...
                    <div class="class-group">
                        <div class="class-group-con">
                            <div class="class-group-title"><i class="class-icon-5"></i>学历/研修</div>
                            <ul class="class-group-sub">
                                <li><a href="/list/xueli/" data-bh="xueli" target="_blank" class="on">学历教育</a></li>
                            </ul>
                ...
                <div class="class-area-right">
                    <div class="class-group">
                        <div class="class-group-con">
                            <div class="class-group-title"><i class="class-icon-2"></i>职业教育</div>
                            <ul class="class-group-sub">
                                <li><a href="/list/kuaiji/" data-bh="kuaiji" target="_blank" class="">财务会计</a></li>
                                <li><a href="/list/jianzhu/" data-bh="jianzhu" target="_blank" class="">建筑工程</a></li>
                                <li><a href="/list/zhiye/" data-bh="zhiye" target="_blank" class="">资格认证</a></li>
                                <li><a href="/list/sheji/" data-bh="sheji" target="_blank" class="">设计培训</a></li>
                                <li><a href="/list/diannao/" data-bh="diannao" target="_blank" class="">IT培训</a></li>
                                <li><a href="/list/jineng/" data-bh="jineng" target="_blank" class="on">就业技能</a></li>
                            </ul>
                    ...
                    <div class="class-group">
                        <div class="class-group-con">
                            <div class="class-group-title"><i class="class-icon-4"></i>外语/留学</div>
                            <ul class="class-group-sub">
                                <li><a href="/list/yingyu/" data-bh="yingyu" target="_blank" class="">英语培训</a></li>
                                <li><a href="/list/xiaoyuzhong/" data-bh="xiaoyuzhong" target="_blank" class="on">小语种</a></li>
                                <li><a href="/list/liuxue/" data-bh="liuxue" target="_blank" class="">出国留学</a></li>
                            </ul>
